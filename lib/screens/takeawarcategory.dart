...
import 'package:restaurantbooking/screens/takecart.dart';

import '../constant.dart';

class TakeAwayCategory extends StatefulWidget {
  const TakeAwayCategory({Key? key}) : super(key: key);

  @override
  _TakeAwayCategoryState createState() => _TakeAwayCategoryState();
}

class _TakeAwayCategoryState extends State<TakeAwayCategory> {
